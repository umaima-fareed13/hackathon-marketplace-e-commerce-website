      ...
      <div className="mx-auto w-full max-w-screen-xl ">
        ...
        <div className=" px-4 py-6 bg-bordercoloryello w-full  md:flex md:items-center md:justify-between">
          ...
          <div className="flex justify-center gap-[14px] ">
            <div className="bg-white w-[36px] h-[34px] flex justify-center items-center rounded"><a href="https://www.facebook.com/profile.php?id=61570862610551&mibextid=ZbWKwL"><FaFacebookF /></a></div>
            <div className="bg-white w-[36px] h-[34px] flex justify-center items-center rounded"><FaTwitter /></div>
            <div className="bg-white w-[36px] h-[34px] flex justify-center items-center rounded"><a href="https://www.instagram.com/umaima_x_fareed/?hl=en">< FaInstagram/></a></div>
